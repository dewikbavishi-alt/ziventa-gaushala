...
check('code in the subject for phone notifications', codeMail.subject.includes('08791920'));
check('code in the HTML body', (codeMail.html ?? '').includes('08791920'));
check('code in the text fallback', codeMail.text.includes('08791920'));
